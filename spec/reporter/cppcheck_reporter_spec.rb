...
require_relative '../../lib/warnings/reporter/cppcheck_reporter'

module Warnings
  describe CppcheckReporter do
    before do
      @dangerfile = testing_dangerfile
      @reporter = CppcheckReporter.new(@dangerfile)
    ...
    it '#default_name' do
      expect(@reporter.default_name).to eq(CppcheckReporter::NAME)
    end
    ...
    it 'runs default xml parser' do
      @reporter.file = Assets::CPPCHECK_XML
      @reporter.report
