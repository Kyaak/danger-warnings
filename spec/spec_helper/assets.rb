module Warnings
  module Assets
    ...
    BANDIT_JSON = "#{ASSETS_DIR}/bandit_json.json".freeze
    BANDIT_EMPTY = "#{ASSETS_DIR}/bandit_json_empty.json".freeze
    BANDIT_MISSING_RESULTS = "#{ASSETS_DIR}/bandit_json_missing_results.json".freeze
    PYLINT_PARSEABLE = "#{ASSETS_DIR}/pylint_parseable.txt".freeze
    RUBOCOP_JSON = "#{ASSETS_DIR}/rubocop_json.json".freeze
    RUBOCOP_MULTI_JSON = "#{ASSETS_DIR}/rubocop_json_multi_offenses.json".freeze
    RUBOCOP_SIMPLE = "#{ASSETS_DIR}/rubocop_simple.txt".freeze
